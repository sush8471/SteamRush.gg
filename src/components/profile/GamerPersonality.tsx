  ...
  return (
    <section className="py-16 px-4 max-w-4xl mx-auto relative overflow-hidden">
      ...
      <div className="relative z-10 text-center">
        <div className="inline-block px-4 py-1.5 mb-6 text-xs font-bold uppercase tracking-[0.3em] text-cyan-400 bg-cyan-950/30 border border-cyan-500/20 rounded-full backdrop-blur-sm animate-pulse">
          Gamer DNA
        </div>

        <div className="relative inline-block group mb-8">
          {/* Animated Outer Glow */}
          <div className="absolute -inset-4 bg-gradient-to-r from-cyan-500/20 via-blue-500/20 to-purple-500/20 rounded-xl blur-2xl group-hover:blur-3xl transition-all duration-700 opacity-70" />
          ...
          <div className="relative px-8 py-10 bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
            ...
            <h2 className="text-4xl md:text-6xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white via-cyan-100 to-cyan-400 mb-6 drop-shadow-[0_0_15px_rgba(34,211,238,0.5)]">
              {gamerType}
            </h2>
